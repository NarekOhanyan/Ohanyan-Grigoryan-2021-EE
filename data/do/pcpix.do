...
* Merge two parts
import excel "${path}/stata/data/in/gPCPIX_1967_1984.xlsx", sheet("gPCPIX_1967_1984") firstrow clear
save `part1'
import excel "${path}/stata/data/in/gPCPIX_1985_Last.xlsx", sheet("gPCPIX_1985_Last") firstrow clear
save `part2'
use `part1'
...
save "${path}/stata/data/tmp/Data_PCPIX_pr.dta",replace
