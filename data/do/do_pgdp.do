...
* Merge two parts
import excel "${path}/stata/data/in/gPGDP_1967_1984.xlsx", sheet("gPGDP_1967_1984") firstrow clear
save `part1'
import excel "${path}/stata/data/in/gPGDP_1985_Last.xlsx", sheet("gPGDP_1985_Last") firstrow clear
save `part2'
use `part1'
...
save "${path}/stata/data/tmp/Data_PGDP_pr.dta",replace
